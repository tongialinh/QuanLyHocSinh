...
namespace DTO
{
    public class DTO_UC2_ThemSuaXemInDiem
    {
        string tenlop_, tenmonhoc_, tenhocky_, datmon_, mahocsinh_, tenhocsinh_;
        string diem15phut_, diem1tiet_, diemtbm_;
        ...
        public string Diem15phut_ { get => diem15phut_; set => diem15phut_ = value; }
        public string Diem1tiet_ { get => diem1tiet_; set => diem1tiet_ = value; }
        public string DiemTBMon_ { get => diemtbm_; set => diemtbm_ = value; }
