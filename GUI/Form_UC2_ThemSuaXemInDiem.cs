...
namespace GUI
{
    public partial class Form_UC2_ThemSuaXemInDiem : Form
    {
        

        public Form_UC2_ThemSuaXemInDiem()
        {
            InitializeComponent();
        }
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    L.Diem15phut_ = txt_diem15p.Text;
                    L.Diem1tiet_ = txt_diem1tiet.Text;
                    L.DiemTBMon_ = txt_diemTBM.Text;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(bm, 30, 300);
