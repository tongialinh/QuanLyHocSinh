...
namespace GUI
{
    public partial class Form_UC1_QuanLyCanBoGiaoVien : Form
    {
        public Form_UC1_QuanLyCanBoGiaoVien()
        {
            InitializeComponent();
        }
        DTO_UC1_QuanLyCanBoGiaoVien L = new DTO_UC1_QuanLyCanBoGiaoVien();
        BUS_UC1_QuanLyCanBoGiaoVien cbgvh = new BUS_UC1_QuanLyCanBoGiaoVien();
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Thao tác sai. Hãy thực hiện lại!");
                }
            }
        }
